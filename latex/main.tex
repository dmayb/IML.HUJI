...
{\LARGE 67577\\Course Book\\ ~\\Week 1}\par % Book title
\vspace*{1cm}
...
\input{chapters/preface/content.tex}
\input{chapters/mathematical.basis/content.tex}
%\input{chapters/intro.regression/content.tex}
%\input{chapters/classification/content.tex}
%\input{chapters/pac/content.tex}
%\input{chapters/ensemble.methods/content.tex}    
%\input{chapters/regularization.model.selection/content.tex}
%\input{chapters/unsupervised.learning/content.tex}
%\input{chapters/gradient.descent/content.tex}
